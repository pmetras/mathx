...
int main();
static void
rmachar(int* ibeta, int* it, int* irnd, int* ngrd, int* machep, int* negep, int* iexp, int* minexp,
        int* maxexp, REAL* eps, REAL* epsneg, REAL* xmin,REAL* xmax);
...
static void rmachar(ibeta,it,irnd,ngrd,machep,negep,iexp,minexp,
